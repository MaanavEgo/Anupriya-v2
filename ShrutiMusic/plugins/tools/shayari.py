...
# Command
SHAYRI_COMMAND = ["gf", "bf", "shayri", "sari", "shari", "shyari", "shayari"]
...
async def shayari_group(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("♡ Sᴜᴘᴘᴏʀᴛ ♡", url="https://t.me/kanhasworld"),
                InlineKeyboardButton("♡ Cʜᴀɴɴᴇʟ ♡", url="https://t.me/aboutkanha")
            ],
            [
                InlineKeyboardButton("♡ Mᴏʀᴇ Sʜᴀʏᴀʀɪ ♡", callback_data="more_shayari")
            ]
        ]
    )
